...
class TimeManagementApp(QMainWindow):
    def __init__(self):
        ...
        # Inicjalizacja struktury danych w pamięci
        self.all_data = {
            "activities": [],
            "days": {}
        }
    ...
    def save_data(self):
        ...
        # Funkcja do niestandardowego formatowania JSON
                ...
                try:
                    ...
                    if "activities" in existing_data and "days" in existing_data:
                        ...
                        with open(file_name, "w", encoding="utf-8") as file:
                            file.write(custom_json_format(existing_data))
                        ...
                        if reply == QMessageBox.Yes:
                            with open(file_name, "w", encoding="utf-8") as file:
                                file.write(custom_json_format(self.all_data))
